...
// ===================================================================================================================================================================
#pragma mark - 网格的View的私有属性和方法
@interface LWScanNetAnimation ()
...
@end
// ===================================================================================================================================================================
#pragma mark - 网格的View的tools方法
@interface LWScanNetAnimation (tools)
...
// ===================================================================================================================================================================
#pragma mark - 网格的View
@implementation LWScanNetAnimation
...
- (void)startAnimatingWithFrame:(CGRect)animationFrame inView:(UIView *)superView withImage:(UIImage *)animationImage
{
    ...
    CGFloat h = self.animationRect.size.height;
    CGFloat y = self.animationRect.origin.y - h;
...
@end
// ===================================================================================================================================================================
#pragma mark - 网格的View的tools方法实现
@implementation LWScanNetAnimation (tools)
...
- (void)beginAnimationing
{
    ...
    [UIView animateWithDuration:0.5f animations:^{
        ...
        [UIView animateWithDuration:2.0f animations:^{
            wself.frame = CGRectMake(x, self.animationRect.origin.y, w, margin);
        } completion:^(BOOL finished) {
            wself.alpha = 0.0f;
